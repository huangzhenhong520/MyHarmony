...
import com.example.myharmony.MainAbility;
import com.example.myharmony.ResourceTable;
import com.example.myharmony.TestAbility;
import com.example.myharmony.utils.ElementUtil;
import com.example.myharmony.utils.Toast;
...
public class MainAbilitySlice extends AbilitySlice {
    private static final String VALID_MAIL = "123456789@abcdefg.com";
    ...
    private void login(final String mail, final String password) {
        ...
        present(new TestAbilitySlice(),intent1);
...
//                                }
    ...
    /**
     * The drawCircleProgress, draw circle progress
     *
